...
// not using this because I use the mCore library
...
void setup() {
  ...
  for (int thisNote = 0; thisNote < notes * 2; thisNote = thisNote + 2) {
    ...
    // When using the MeMcore.h library duration should be 0.1*noteduration
    // When using pin number delay should be: noteduration*1
